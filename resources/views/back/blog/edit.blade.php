...
@section('content')
    <div class="row g-0">
        ...
        <h1 class="text-center mb-3">edit berita/Artikel</h1>
        @if ($errors->any())
        ...
        <div class="col-md-12 mb-3">
            <form action="{{ route('blog.update', ['blog' => $data->id]) }}" method="post" enctype="multipart/form-data">
                ...
                @isset($data->thumbnail)
                    <img src="{{ asset('thumbnail/' . $data->thumbnail) }}" alt="" class="img-thumbnail" width="15%">
                @endisset
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="status" id="status" class="form-select">
                        <option value="publish" {{ old('status', $data->status) == 'publish' ? 'selected' : '' }}>publish
                        </option>
